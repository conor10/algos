...
class OptionTests(unittest.TestCase):
    ...
    def test_call_price_with_dividend(self):
        option = Option(OptionType.CALL, 40.0, 42.0,
    ...
    def test_put_price_with_dividend(self):
        option = Option(OptionType.PUT, 40.0, 42.0,
                        0.3, 0.5, risk_free_rate=0.05,
                        dividend_rate=0.03)
        self.assertEqual(0.3832055088531541, option.d1)
        self.assertEqual(0.17107347449718982, option.d2)
    ...
    def test_implied_volatility_call_with_dividend(self):
        implied_volatility = \
            option.implied_volatility(OptionType.CALL, 40.0, 42.0, 4.71, 0.5,
    ...
    def test_implied_volatility_call_no_dividend(self):
        implied_volatility = \
            option.implied_volatility(OptionType.CALL, 40.0, 42.0, 4.76, 0.5,
                                      risk_free_rate=0.1)
    ...
    def test_greeks_joshi(self):
        call = Option(OptionType.CALL, 110.0, 100.0, 0.1, 1.0, 0.0, 0.05, 0.0)
        ...
        put = Option(OptionType.PUT, 110.0, 100.0, 0.1, 1.0, 0.0, 0.05, 0.0)
    ...
    def test_greeks_hull(self):
        call = Option(OptionType.CALL, 50.0, 49.0, 0.2, 0.3846, 0.0, 0.05, 0.0)
